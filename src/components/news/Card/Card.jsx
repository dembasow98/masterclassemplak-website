...
const Card = () => {
  return (
    <div className="mx-10 my-6 md:mx-10 min-h-screen dark:bg-gray-900 px-10 py-6 rounded-md shadow-3xl grid place-items-center font-mono">
        <div className=''>
        ...
        <div className="md:flex mt-10 dark:bg-gray-800 rounded-md shadow-3xl flex-col px-4 leading-none">
            <div className="flex-none">
                <img
                    src="https://creativereview.imgix.net/content/uploads/2019/12/joker_full.jpg?auto=compress,format&q=60&w=1012&h=1500"
                    alt="pic"
                    className="h-40 w-48 rounded-md dark:shadow-2xl transform -translate-y-4 border-4 border-gray-300 shadow-3xl"
                />           
            </div>
