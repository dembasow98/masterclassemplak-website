...
//import the blogs data from the blogs.json file
...
const Card = () => {
  ...
  return (
        <section className="bg-green-800 md:min-h-screen my-8 px-4 md:py-0 md:my-0 mx-auto max-w-screen-xl  lg:px-6">
            ...
            <div className="grid gap-6 w-full ">
                <div className='flex flex-col  content-center justify-center sm:flex-row  md:flex-col lg:flex-row rounded-lg border border-gray-200  dark:bg-gray-800 dark:border-gray-700'>
                    ...
                    <article className="flex flex-col p-6">
                        ...
                        <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><Link to="/">How to quickly deploy a static website</Link></h2>
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <Link to="/" className="inline-flex items-center dark:text-green-600 font-medium text-primary-600 dark:text-primary-500 hover:underline">
                                Read more
