        ...
        {showDropdown && (
            <div className="absolute right-0 z-10 mt-2 w-fit px-2 origin-top-right rounded-md  bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
                <div className="py-2 px-2 font-bold" role="none">
                    <a href="/tr" className="text-gray-700 px-6 flex flex-row items-center rounded-md dark:text-gray-200 py-2 cursor-pointer hover:bg-gray-900 text-sm" role="menuitem" tabIndex="-1" id="menu-item-0">
                    ...
                    <a href="/en" className="text-gray-700 px-6 flex flex-row items-center rounded-md dark:text-gray-200 py-2 cursor-pointer hover:bg-gray-900 text-sm" role="menuitem" tabIndex="-1" id="menu-item-0">
                    ...
                    <a href="/ar" className="text-gray-700 px-6 rounded-md dark:text-gray-200 items-center flex flex-row py-2 cursor-pointer hover:bg-gray-900 text-sm" role="menuitem" tabIndex="-1" id="menu-item-1">
                    ...
                    <a href="/fr" className="text-gray-700 px-6 rounded-md dark:text-gray-200 items-center flex flex-row py-2 cursor-pointer hover:bg-gray-900 text-sm" role="menuitem" tabIndex="-1" id="menu-item-2">
