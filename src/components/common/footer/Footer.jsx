...
const Footer = () => {
  return (
    <footer class="bg-white dark:bg-[#043334] ">
        <div class="flex flex-col items-center mx-6 py-3 justify-between md:flex-row">
            <div className="flex-shrink-0 justify-center">
                <img src={logo} alt="logo" className=" w-42 h-36 " />
            </div>
            <div class="flex flex-col items-center justify-center mt-6 space-y-6 md:flex-row md:space-y-0 md:space-x-6 md:mt-0">
                <div class="flex flex-col items-center justify-center space-y-2 px-6">
                    <span class="text-gray-700 text-xl dark:text-gray-200">Call Us</span>
                    <FiPhoneCall className='w-10 h-10 text-gray-400'/>
                    <span class="text-gray-700  font-md hover:text-gray-100 font-md dark:text-gray-300">+90 534 567 8941</span>
                </div>
                <div class="flex flex-col items-center justify-center space-y-2 px-6">
                    <span class="text-gray-700 text-xl dark:text-gray-200">Email Us</span>
                    <BiMailSend className='w-10 h-10 text-gray-400'/>
                    <span class="text-gray-700 hover:cursor-pointer hover:text-gray-100 font-md dark:text-gray-300">
                        <a href="mailto:masterclassemlak@gmail.com"> masterclassemlak@gmail.com</a>
                    </span>
                </div>

            </div>
            <div class="flex space-x-6 sm:justify-center flex-col md:mt-0 my-4">
                <div className='flex items-center justify-center my-2'>
                    <span class="text-gray-700 text-xl dark:text-gray-200">Follow Us</span>
                </div>
