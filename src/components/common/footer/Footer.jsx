  ...
  return (
    <footer className="bg-white dark:bg-[#043334]">
        <div className="flex flex-col items-center mx-6 py-3 justify-between md:flex-row">
            ...
            <div className="flex flex-col items-center justify-center mt-6 space-y-6 md:flex-row md:space-y-0 md:space-x-6 md:mt-0">
                <div className="flex flex-col items-center justify-center space-y-2 px-6">
                    <span className="text-gray-700 text-xl dark:text-gray-200">Call Us</span>
                    <FiPhoneCall className='w-10 h-10 text-gray-400'/>
                    <span className="text-gray-700  font-md hover:text-gray-100 font-md dark:text-gray-300">+90 534 567 8941</span>
                </div>
                <div className="flex flex-col items-center justify-center space-y-2 px-6">
            ...
            <div className="flex space-x-6 sm:justify-center flex-col md:mt-0 my-4">
                <div className='flex items-center justify-center my-2'>
                    <span className="text-gray-700 text-xl dark:text-gray-200">Follow Us</span>
                </div>
                <div className='flex items-center justify-center gap-2 lg:gap-3'>
                    <a href="/hello" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
        ...
        <div className="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
            <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="/hello" className=" hover:underline">About</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Careers</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Brand Center</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Blog</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Discord Server</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Twitter</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Facebook</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Contact Us</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Privacy Policy</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Licensing</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Terms &amp; Conditions</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">iOS</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Android</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">Windows</a>
                    </li>
                    <li className="mb-4">
                        <a href="/hello" className="hover:underline">MacOS</a>
                    </li>
                </ul>
            </div>
        </div>
