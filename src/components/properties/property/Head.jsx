  ...
  return (
    <div className="flex flex-col items-center justify-center md:justify-between md- md:flex-row w-full py-4 shadow-gray-800 shadow-lg ">
      <div className ="md:w-2/3 ">
        <div className="flex w-full flex-row md:px-10 px-4 lg:px-12 justify-center md:justify-start items-center my-4 ">
          <p className=" text-center text-lg md:text-xl text-gray-900 dark:text-gray-300">{title} - {description}</p>
        </div>
        <div className="flex w-full flex-row md:px-10 px-4 lg:px-12 justify-center  md:justify-start gap-8 sm:gap-10 items-center">
            ...
            <div className="flex flex-col justify-start ">
              <p className="md:font-bold text-gray-900 dark:text-gray-100"><span className="text-green-700">Created: </span>{createdAt}</p>
              {
                createdAt !== updatedAt && <p className="md:font-bold text-gray-900 dark:text-gray-100"><span className="text-green-700">Updated: </span>{updatedAt}</p>
              }
            </div>
        </div>
      </div>
